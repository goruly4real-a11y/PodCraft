...
import { ArrowLeft, Headphones, Upload, FileText, Loader2, X, Mic, Clock, Zap, Home, CreditCard, LogOut } from 'lucide-react';
      ...
      <main className="flex-1 overflow-auto">
        <div className="p-8 max-w-3xl">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold font-display">New Podcast</h1>
              <p className="text-muted-foreground">Create an AI-powered podcast episode</p>
            </div>
          </div>
        {/* Steps Indicator */}
